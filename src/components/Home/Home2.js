      ...
      <Container>
        <Row>
          <Col md={16} className="home-about-description">
            ...
            A dedicated fourth-year Computer Engineering student at ENSA Hoceima. With a passion for technology and a strong academic background, I am eager to apply my skills and knowledge in real-world settings.
            </p>
          </Col>
